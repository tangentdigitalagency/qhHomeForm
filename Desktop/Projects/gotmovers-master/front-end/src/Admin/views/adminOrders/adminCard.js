...
const devices = [
    {
      ...
      title: <h5>From</h5>,
    value:<span> {props.rowData?.reservation?.from}<br/><span>{props.rowData.name}</span><br/><span>{props.rowData.phoneClient}</span></span>,
      icon: <img 
    ...
    {
      title: <h5>TO</h5>,
      value: <span> {props.rowData?.reservation?.to}<br/><span>{props.rowData.name}</span><br/><span>{props.rowData.phoneUser}</span><span><br/></span>{props.rowData.storeAddress}</span>,
      icon: <img 
