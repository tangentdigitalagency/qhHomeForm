...
class S1UserForm extends Component {
	state = {
		...
		TYPE: "48",
		IP_Address: "",
		SRC: 'Quantum_Website_Umbrella',
		Redirect_URL: 'https://www.quantumassurance.com/quotes/thank-you',
	...
	render() {
		...
		>
			<div id="imgContainer">
				<img src={require("../Assets/logoQ.png")} className="m-4" width="200px" alt="" />
				<br />
			</div>

			<div className='container p-0' style={{textAlign:'-webkit-center'}}>
				<h1 className='text-center main-heading'>Quantum Provides You With Top Rated Umbrella Insurance</h1>
				<div className='main-content-inner-container mb-5' style={{maxWidth:'40rem'}}>
					<div className='text-center whiteWrapper' style={{padding:'50px 50px'}}>
						<Form name='customized_form_controls'>
							...
							<Form.Item style={{ width: '100%' }}>
								<Button className='primaryBTN' disabled={this.state.First_Name === '' || this.state.Last_Name === '' || this.state.Email === '' || this.state.Address === '' || this.state.Primary_Phone === ''} type='primary' onClick={this.getQuoteHandler} style={{ width: '100%' }} size={'large'}>
									<h4 className='buttonContent'>Get My Quote</h4>
								</Button>
							</Form.Item>
						</Form>
					</div>
